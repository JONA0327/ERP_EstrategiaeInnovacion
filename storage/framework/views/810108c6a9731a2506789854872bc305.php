...
<?php endif; ?>
        ...
        <div class="mt-6 text-center">
            <a href="<?php echo e(route('login')); ?>" class="text-sm font-bold text-slate-600 hover:text-indigo-600 transition-colors">
                Iniciar Sesión
            </a>
        </div>
    </form>
...
<?php endif; ?><?php /**PATH C:\Users\trade\Desktop\Proyectos\ERP_EstrategiaeInnovacion\resources\views\Sistemas_IT/auth/register.blade.php ENDPATH**/ ?>