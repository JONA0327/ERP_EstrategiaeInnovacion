    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $adminCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 flex flex-col justify-between h-full group hover:shadow-md transition-all duration-300 <?php echo e($card['hover_border']); ?>">
                    
                    <div class="flex items-start justify-between mb-4">
                        <div class="p-3 <?php echo e($card['color_bg']); ?> <?php echo e($card['color_text']); ?> rounded-2xl transition-colors">
                    ...
                    <div class="mb-6">
                        <h2 class="text-xl font-bold text-slate-900 mb-2"><?php echo e($card['title']); ?></h2>
                        <p class="text-slate-500 text-sm leading-relaxed"><?php echo e($card['description']); ?></p>
                    </div>

                    <div class="mt-auto pt-4 border-t border-slate-100">
                        <a href="<?php echo e($card['route']); ?>"
                           class="group flex items-center justify-center w-full px-4 py-3 <?php echo e($card['btn_color']); ?> text-white font-bold text-sm rounded-xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                            <?php echo e($card['cta']); ?>
