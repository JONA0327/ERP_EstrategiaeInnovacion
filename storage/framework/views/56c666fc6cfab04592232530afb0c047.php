                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="bg-slate-700 rounded-lg p-4 mb-4">
                            <h4 class="font-semibold text-sm mb-3">📊 Desglose de Eficiencia</h4>
                            <div class="grid grid-cols-2 gap-4 text-xs">
                                ...
                                <div>
                                    <p class="text-red-400">❌ <strong>Operaciones Problemáticas: <?php echo e($totalOps - $operacionesExitosas); ?></strong></p>
                    ...
                    <div>
                        ...
                        <div class="bg-slate-700 rounded-lg p-4 mb-4">
                            <div class="space-y-2">
                                <div class="text-sm font-semibold text-blue-300 mb-2">🚀 Operaciones Activas:</div>
                                ...
                                <div class="ml-4 space-y-1 text-xs">
                                    ...
                                    <div class="flex justify-between items-center">
                                        <span class="text-orange-400">⏰ Finalizadas con Retraso:</span>
                                ...
                                <div class="pt-2 mt-2 border-t border-slate-600 flex justify-between items-center">
                                    <span class="font-semibold text-blue-400">📊 Total:</span>
                ...
                <div id="pedimentos-reportes" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        ...
                        <div class="bg-white rounded-lg shadow p-4">
                            ...
                            <div class="text-2xl font-bold text-emerald-600">$<?php echo e(number_format($pedimentoStats['montoPagadoMXN'] ?? 0, 2)); ?></div>
                        </div>
                        <div class="bg-white rounded-lg shadow p-4">
                            <div class="text-sm text-slate-500">Monto USD</div>
                            <div class="text-2xl font-bold text-blue-600">$<?php echo e(number_format($pedimentoStats['montoPagadoUSD'] ?? 0, 2)); ?></div>
                        </div>
                        <div class="bg-white rounded-lg shadow p-4">
                            <div class="text-sm text-slate-500">Monto EUR</div>
                            <div class="text-2xl font-bold text-purple-600">€<?php echo e(number_format($pedimentoStats['montoPagadoEUR'] ?? 0, 2)); ?></div>
                        </div>
                    </div>
