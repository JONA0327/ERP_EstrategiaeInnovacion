                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="<?php echo e(route('rh.evaluacion.index', ['area' => $area ?? 'General'])); ?>" class="ml-1 hover:text-black transition-colors"><?php echo e($area ?? 'General'); ?></a>
                        </div>
                    </li>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden sticky top-6">
                <div class="p-4 border-b border-gray-200 bg-gray-50">
                    <h3 class="font-bold text-gray-700 flex items-center text-sm uppercase tracking-wider">
                        ...
                        Equipo: <?php echo e($area ?? 'General'); ?>
                    ...
                    <ul class="divide-y divide-gray-100">
                        <?php if(isset($empleados) && count($empleados) > 0): ?>
                            <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(route('rh.evaluacion.show', $emp->id)); ?>" class="block p-3 hover:bg-gray-50 transition duration-200 group <?php echo e($empleado->id === $emp->id ? 'bg-gray-50 border-l-4 border-indigo-500 pl-2' : 'border-l-4 border-transparent'); ?>">
                                        <div class="flex items-center space-x-3">
                                            <div class="flex-shrink-0 relative">
                                                <div class="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-xs font-bold text-indigo-600 overflow-hidden border border-gray-200 uppercase">
                                                    ...
                                                    <?php else: ?>
                                                        <?php echo e(substr($emp->nombre, 0, 1)); ?><?php echo e(substr($emp->apellido_paterno ?? '', 0, 1)); ?>
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-medium text-gray-700 truncate group-hover:text-black transition-colors">
                                                    <?php echo e($emp->nombre); ?> <?php echo e($emp->apellido_paterno ?? ''); ?>
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <div class="flex flex-wrap justify-center md:justify-start gap-2 mb-4">
                            ...
                            <?php if($empleado->numero_empleado): ?>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-700 border border-gray-200">
                                ID: <?php echo e($empleado->numero_empleado); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm text-gray-600 mt-4 font-medium border-t border-gray-100 pt-4">
                            ...
                            <div class="flex items-center justify-center md:justify-start">
                                ...
                                <span>Ingreso: <?php echo e(\Carbon\Carbon::parse($empleado->fecha_ingreso)->format('d/m/Y')); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
