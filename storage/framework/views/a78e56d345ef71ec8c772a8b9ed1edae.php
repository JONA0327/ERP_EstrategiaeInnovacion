...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <?php if(Auth::user()->role === 'admin' || (isset(Auth::user()->empleado) && str_contains(strtolower(Auth::user()->empleado->posicion), 'rh'))): ?>
            <a href="<?php echo e(route('rh.capacitacion.manage')); ?>" class="px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 text-sm font-bold">
                Gestionar Videos (RH)
            </a>
        <?php endif; ?>
    </div>
    ...
    <?php else: ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('capacitacion.show', $video->id)); ?>" class="group block bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden border border-gray-200">
                    ...
                    <div class="p-4">
                        <h3 class="text-lg font-bold text-gray-900 group-hover:text-indigo-600 transition-colors"><?php echo e($video->titulo); ?></h3>
                        <p class="mt-1 text-sm text-gray-500 line-clamp-2"><?php echo e($video->descripcion); ?></p>
                        <div class="mt-4 flex items-center text-xs text-gray-400">
                            <span>Subido el <?php echo e($video->created_at->format('d M, Y')); ?></span>
                        </div>
                    </div>
                </a>
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\trade\Desktop\Proyectos\ERP_EstrategiaeInnovacion\resources\views/Recursos_Humanos/capacitacion/index.blade.php ENDPATH**/ ?>