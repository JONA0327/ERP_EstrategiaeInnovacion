...
<?php $__env->startSection('title', 'Panel de Administración - Sistema IT'); ?>
                    ...
                    <?php $__currentLoopData = $adminCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="relative overflow-hidden rounded-3xl border border-blue-100/70 bg-white/85 p-8 shadow-lg shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl backdrop-blur">
                            ...
                            <div class="relative flex flex-col items-center text-center sm:items-start sm:text-left">
                                <span class="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br <?php echo e($card['accent']); ?> text-white shadow-lg shadow-blue-500/30">
                                    <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($card['icon']); ?>" />
                                    </svg>
                                </span>
                                <h2 class="text-xl font-semibold text-slate-900"><?php echo e($card['title']); ?></h2>
                                <p class="mt-2 text-sm text-slate-600"><?php echo e($card['description']); ?></p>
                                <a
                                    href="<?php echo e($card['route']); ?>"
                                    class="group mt-6 inline-flex w-full items-center justify-center rounded-xl bg-gradient-to-r <?php echo e($card['accent']); ?> px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 transition-all duration-300 hover:brightness-110"
                                >
    ...
    <footer class="bg-white border-t border-blue-100">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="text-center text-slate-500 text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> Panel de Administración - Sistema IT. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SISTEMAS\Downloads\ERP EstrategiaeInnovacion\Sistema_Tickets_E-I\resources\views\Sistemas_IT/admin/dashboard.blade.php ENDPATH**/ ?>