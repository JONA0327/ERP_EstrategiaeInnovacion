            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col gap-4 py-5 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center">
                        <img src="<?php echo e(asset('images/logo-ei.png')); ?>" alt="E&I Logo" class="h-12 w-auto mr-3">
                        <div>
                    ...
                    <?php if (isset($component)) { $__componentOriginal67d5c2e4e8e41cdb856ed816b6a1669d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67d5c2e4e8e41cdb856ed816b6a1669d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.authenticated-actions','data' => ['theme' => 'blue']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('authenticated-actions'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['theme' => 'blue']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal67d5c2e4e8e41cdb856ed816b6a1669d)): ?>
<?php $attributes = $__attributesOriginal67d5c2e4e8e41cdb856ed816b6a1669d; ?>
<?php unset($__attributesOriginal67d5c2e4e8e41cdb856ed816b6a1669d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal67d5c2e4e8e41cdb856ed816b6a1669d)): ?>
<?php $component = $__componentOriginal67d5c2e4e8e41cdb856ed816b6a1669d; ?>
<?php unset($__componentOriginal67d5c2e4e8e41cdb856ed816b6a1669d); ?>
<?php endif; ?>
                </div>
            </div>
        </header>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-wrap items-center gap-3 text-sm text-blue-100/90">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span>Última actualización: <?php echo e(optional(auth()->user()->updated_at)->format('d/m/Y H:i')); ?></span>
                                </div>
            ...
            <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-16">
                <div class="grid grid-cols-1 gap-8 xl:grid-cols-3">
                    ...
                    <aside class="space-y-6" id="preferencias">
                        <div class="bg-white/90 backdrop-blur rounded-2xl shadow-lg border border-blue-100 p-6">
                            <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                                ...
                                <div>
                                    ...
                                    <h2 class="text-lg font-semibold text-gray-900 leading-tight"><?php echo e(auth()->user()->name); ?></h2>
                                    <p class="text-sm text-gray-500 break-all"><?php echo e(auth()->user()->email); ?></p>
                                </div>
                            </div>
                            ...
                            <dl class="mt-6 space-y-4 text-sm text-gray-600">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-gray-900"><?php echo e(auth()->user()->isAdmin() ? 'Administrador' : 'Usuario'); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3">
                                    <span class="mt-1 inline-flex items-center justify-center w-8 h-8 rounded-lg bg-blue-100 text-blue-600">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-gray-900"><?php echo e(optional(auth()->user()->created_at)->format('d/m/Y')); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3">
                                    <span class="mt-1 inline-flex items-center justify-center w-8 h-8 rounded-lg bg-blue-100 text-blue-600">
                        ...
                        <a
                            href="<?php echo e(auth()->user()->isAdmin() ? route('admin.dashboard') : route('welcome')); ?>"
                        ...
                        >
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-left">
                                    <p><?php echo e(auth()->user()->isAdmin() ? 'Volver al Panel de Administración' : 'Volver al Portal de Tickets'); ?></p>
...
<?php /**PATH C:\Users\trade\Desktop\Proyectos\ERP_EstrategiaeInnovacion\resources\views\Sistemas_IT/profile/edit.blade.php ENDPATH**/ ?>