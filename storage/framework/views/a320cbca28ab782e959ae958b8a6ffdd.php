...
<?php if($icon): ?>
    <svg <?php echo e($attributes->merge(['class' => $class])); ?> fill="none" viewBox="<?php echo e($icon['viewBox']); ?>" stroke-width="<?php echo e($strokeWidth); ?>" stroke="currentColor" aria-hidden="true">
        <?php $__currentLoopData = $icon['paths']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $path): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <path stroke-linecap="<?php echo e($path['stroke-linecap'] ?? 'round'); ?>" stroke-linejoin="<?php echo e($path['stroke-linejoin'] ?? 'round'); ?>" d="<?php echo e($path['d']); ?>" />
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </svg>
<?php endif; ?>
<?php /**PATH C:\Users\SISTEMAS\Downloads\ERP EstrategiaeInnovacion\Sistema_Tickets_E-I\resources\views\Sistemas_IT/components/ui/icon.blade.php ENDPATH**/ ?>