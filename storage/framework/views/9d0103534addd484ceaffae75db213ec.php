...
<?php $__env->startSection('title', 'Tablero de Actividades'); ?>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
            ...
            <div class="flex gap-3 mt-4 md:mt-0">
                <div class="text-right hidden lg:block mr-4">
                    ...
                    <p class="text-sm font-bold text-indigo-600"><?php echo e(now()->isoFormat('D [de] MMMM, YYYY')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between hover:shadow-md transition">
                <div class="flex justify-between items-start">
                    ...
                    <span class="text-2xl font-bold text-slate-800"><?php echo e($kpis['total']); ?></span>
                </div>
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between hover:shadow-md transition">
                <div class="flex justify-between items-start">
                    ...
                    <span class="text-2xl font-bold text-emerald-600"><?php echo e($kpis['completadas']); ?></span>
                </div>
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between hover:shadow-md transition">
                <div class="flex justify-between items-start">
                    ...
                    <span class="text-2xl font-bold text-blue-600"><?php echo e($kpis['proceso']); ?></span>
                </div>
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between hover:shadow-md transition">
                <div class="flex justify-between items-start">
                    ...
                    <span class="text-2xl font-bold text-slate-600"><?php echo e($kpis['pendientes']); ?></span>
                </div>
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-red-100 flex flex-col justify-between hover:shadow-md transition relative overflow-hidden group">
                ...
                <div class="flex justify-between items-start relative z-10">
                    ...
                    <span class="text-2xl font-bold text-red-600"><?php echo e($kpis['retardos']); ?></span>
                </div>
            ...
            <div class="flex flex-col lg:flex-row justify-between gap-4 items-center">
                ...
                <form method="GET" class="flex flex-wrap gap-2 items-center w-full lg:w-auto">
                    ...
                    <div class="relative w-full lg:w-64">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Buscar actividad, responsable..." class="w-full pl-9 pr-4 py-2 bg-slate-50 border-transparent focus:bg-white focus:border-indigo-300 focus:ring-0 rounded-xl text-xs font-medium transition-all">
            ...
            <form action="<?php echo e(route('activities.store')); ?>" method="POST" class="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                ...
                <div class="col-span-12 md:col-span-2">
                    ...
                    <select name="area" class="w-full text-xs rounded-lg border-slate-300 focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer bg-white" required>
                        ...
                        <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $areaOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($areaOption); ?>"><?php echo e($areaOption); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\trade\Desktop\Proyectos\ERP_EstrategiaeInnovacion\resources\views/activities/index.blade.php ENDPATH**/ ?>