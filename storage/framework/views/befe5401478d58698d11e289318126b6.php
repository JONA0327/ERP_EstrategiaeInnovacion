...
<div class="min-h-screen bg-slate-50 pb-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <span class="text-sm text-slate-400 font-medium"><?php echo e(date('F  d\t\h, Y')); ?></span>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <a href="<?php echo e(route('rh.expedientes.index')); ?>" class="group relative bg-white rounded-3xl p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col">
            ...
            <a href="<?php echo e(route('rh.reloj.index')); ?>" class="group relative bg-white rounded-3xl p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col">
            ...
            <a href="<?php echo e(route('rh.evaluacion.index')); ?>" class="group relative bg-white rounded-3xl p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-indigo-600 rounded-3xl p-6 text-white flex items-center justify-between shadow-lg shadow-indigo-200 relative overflow-hidden group">
                ...
                <a href="<?php echo e(route('welcome', ['from' => 'tickets'])); ?>" class="relative z-10 bg-white/20 backdrop-blur-sm border border-white/30 text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-white hover:text-indigo-600 transition-all">
                    Nuevo Ticket
                </a>
            </div>
        </div>
