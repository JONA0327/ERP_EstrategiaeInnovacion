<?php $__env->startSection('content'); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-bold text-2xl text-slate-800 leading-tight tracking-tight">
            <?php echo e(__('Recursos Humanos')); ?>
    ...
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                ...
                <a href="<?php echo e(route('rh.expedientes.index')); ?>" class="group relative bg-white rounded-3xl p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                ...
                <a href="<?php echo e(route('rh.reloj.index')); ?>" class="group relative bg-white rounded-3xl p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                    <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                <a href="<?php echo e(route('rh.evaluacion.index')); ?>" class="group relative bg-white rounded-3xl p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                    <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-slate-800 rounded-2xl p-6 text-white flex items-center justify-between shadow-lg">
                    ...
                    <a href="<?php echo e(route('tickets.create', ['tipo' => 'incidente'])); ?>" class="bg-indigo-500 text-white px-4 py-2 rounded-lg font-bold text-sm hover:bg-indigo-600 transition">
                        Nuevo Ticket
                    </a>
                </div>
            </div>
