...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="text-sm font-semibold text-indigo-600 hover:text-indigo-800 transition-colors" href="<?php echo e(route('password.request')); ?>">
        ...
        <div class="mt-6 text-center">
            <a href="<?php echo e(route('register')); ?>" class="text-sm font-bold text-slate-600 hover:text-indigo-600 transition-colors">
...
<?php endif; ?><?php /**PATH C:\Users\trade\Desktop\Proyectos\ERP_EstrategiaeInnovacion\resources\views\Sistemas_IT/auth/login.blade.php ENDPATH**/ ?>