        ...
        <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8" data-admin-users-index>
                ...
                <div class="bg-white shadow-xl rounded-lg border border-yellow-200 mb-10">
                    <div class="px-6 py-4 border-b border-yellow-100 bg-yellow-50 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-600"><?php echo e($pendingUsers->count()); ?> usuario(s) esperan aprobación</p>
                        </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $pendingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-yellow-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($user->created_at->format('d/m/Y H:i')); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex flex-col lg:flex-row lg:justify-end lg:items-center gap-3">
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.users.reject', $user)); ?>" class="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-2">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="text"
                                                           name="reason"
            ...
            <div class="bg-white shadow-xl rounded-lg border border-blue-100">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600"><?php echo e($approvedUsers->total()); ?> usuario(s) con acceso</p>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $approvedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center mr-3">
                                                    <span class="text-white text-sm font-medium"><?php echo e(substr($user->name, 0, 1)); ?></span>
                                                </div>
                                                <div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($user->role === 'admin' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'); ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($user->tickets()->count()); ?> ticket(s)
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <?php $__currentLoopData = $rejectedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="px-6 py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:gap-4 text-sm text-gray-500">
                                    <span>
                                        Rechazado el <?php echo e(optional($user->rejected_at)->format('d/m/Y H:i') ?? $user->updated_at->format('d/m/Y H:i')); ?>

                                    </span>
                                    <form method="POST" action="<?php echo e(route('admin.users.rejections.destroy', $user)); ?>" class="sm:ml-4"
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $blockedEmails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blocked): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($blocked->email); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($blocked->reason ?? 'Sin especificar'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($blocked->created_at->format('d/m/Y H:i')); ?></td>
        ...
        <footer class="bg-white border-t border-blue-100 mt-16">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div class="text-center text-gray-500 text-sm">
                    <p>&copy; <?php echo e(date('Y')); ?> Sistema de Tickets TI. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SISTEMAS\Downloads\ERP EstrategiaeInnovacion\Sistema_Tickets_E-I\resources\views\Sistemas_IT/admin/users/index.blade.php ENDPATH**/ ?>