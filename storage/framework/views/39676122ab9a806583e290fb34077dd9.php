                    ...
                    <div class="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div class="self-start lg:self-center">
                            <div class="rounded-2xl border border-blue-100 bg-white/80 px-6 py-5 shadow-inner shadow-blue-100/40">
                                ...
                                <p class="mt-1 text-3xl font-bold text-blue-700"><?php echo e($tickets->total()); ?></p>
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-slate-900"><?php echo e($abiertos); ?></p>
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-slate-900"><?php echo e($enProceso); ?></p>
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-slate-900"><?php echo e($cerrados); ?></p>
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-slate-900"><?php echo e($software); ?></p>
                    ...
                    <div class="relative flex items-start justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-slate-900"><?php echo e($hardware); ?></p>
                    ...
                    <div class="relative flex flex-col gap-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-slate-900"><?php echo e($mantenimiento); ?></p>
                                <p class="text-xs text-slate-400 mt-1">Visitas programadas y preventivas</p>
                            </div>
                        </div>
                        <a href="<?php echo e(route('admin.maintenance.index')); ?>" class="inline-flex items-center text-sm font-semibold text-emerald-600 hover:text-emerald-700 transition-colors">
                            Configurar horarios
                    ...
                    <div class="relative px-6 py-6 border-b border-blue-100/80">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div class="inline-flex items-center rounded-full border border-blue-100 bg-blue-50/60 px-4 py-1 text-xs font-semibold text-blue-700">
                                Actualizado al <?php echo e(now()->format('d/m/Y H:i')); ?>
                        ...
                        <table class="min-w-full divide-y divide-blue-100">
                            ...
                            <tr class="transition-colors duration-200 hover:bg-blue-50/60">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-semibold text-blue-600"><?php echo e($ticket->folio); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-slate-900"><?php echo e($ticket->nombre_solicitante); ?></div>
                                    <div class="text-xs text-slate-500"><?php echo e($ticket->correo_solicitante); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php if($ticket->tipo_problema === 'software'): ?> bg-blue-100 text-blue-800
                                        <?php elseif($ticket->tipo_problema === 'hardware'): ?> bg-orange-100 text-orange-800
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($ticket->estado_badge); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($ticket->prioridad): ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($ticket->prioridad_badge); ?>">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SISTEMAS\Downloads\ERP EstrategiaeInnovacion\Sistema_Tickets_E-I\resources\views\Sistemas_IT/admin/tickets/index.blade.php ENDPATH**/ ?>