...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Evaluaciones de Desempeño')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <?php $__currentLoopData = $todasLasCategorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($categoria)): ?>
                            <button 
                                ...
                                :class="activeTab === '<?php echo e($categoria); ?>' 
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <?php $__currentLoopData = $todasLasCategorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($categoria)): ?>
                            <div x-show="activeTab === '<?php echo e($categoria); ?>'" 
                                ...
                                <div class="flex justify-between items-center mb-4">
                                    <h4 class="text-xl font-bold text-gray-800">Área: <?php echo e($categoria); ?></h4>
                                    <span class="bg-indigo-100 text-indigo-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded border border-indigo-400">
                                        <?php echo e($empleados->filter(fn($e) => str_contains($e->posicion, $categoria) || $e->posicion == $categoria)->count()); ?> Colaboradores
                                    </span>
                                </div>
                                ...
                                <?php if($empleadosCategoria->isEmpty()): ?>
                                    <div class="text-center py-10 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">No hay colaboradores asignados a <?php echo e($categoria); ?> actualmente.</p>
                                    </div>
                                <?php else: ?>
                                            ...
                                            <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 p-6 relative group">
                                                ...
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <p class="text-sm font-medium text-gray-900 truncate" title="<?php echo e($empleado->nombre); ?> <?php echo e($empleado->apellido_paterno); ?>">
                                                            <?php echo e($empleado->nombre); ?> <?php echo e($empleado->apellido_paterno); ?>

                                                        </p>
                                                        <p class="text-xs text-gray-500 truncate">
                                                            <?php echo e($empleado->posicion); ?>
                                                ...
                                                <div class="mt-4 border-t border-gray-100 pt-4 flex justify-between items-center">
                                                    ...
                                                    <a href="<?php echo e(route('rh.evaluacion.show', $empleado->id)); ?>" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">
                                                        Evaluar &rarr;
                                                    </a>
                                                </div>
                                            </div>
