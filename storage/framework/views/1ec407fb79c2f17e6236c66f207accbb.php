<?php $__env->startSection('title', 'Portal Corporativo - Estrategia e Innovación'); ?>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16">
            ...
            <?php if(session('success') || session('info')): ?>
                <div class="max-w-3xl mx-auto mb-10 animate-fade-in-up">
                    <div class="flex items-center gap-3 p-4 rounded-xl border <?php echo e(session('success') ? 'bg-emerald-50 border-emerald-100 text-emerald-700' : 'bg-blue-50 border-blue-100 text-blue-700'); ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <span class="text-sm font-medium"><?php echo e(session('success') ?? session('info')); ?></span>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <div class="flex flex-col items-center justify-center min-h-[70vh]">
                    ...
                    <div class="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden transform transition-all hover:scale-[1.01] duration-300">
                        ...
                        <div class="p-8">
                            ...
                            <div class="space-y-3">
                                <a href="<?php echo e(route('login')); ?>" class="block w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg text-center transition shadow-lg shadow-indigo-100 text-sm">
                                    Ingresar con Credenciales
                                </a>
                                <a href="<?php echo e(route('register')); ?>" class="block w-full py-3 px-4 bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 font-semibold rounded-lg text-center transition text-sm">
                                    Solicitar Acceso
                                </a>
                            </div>
                        </div>
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-12 border-b border-slate-200 pb-6">
                    <div>
                        <p class="text-sm font-semibold text-indigo-600 uppercase tracking-wider mb-1">
                            <?php echo e(date('d')); ?> de <?php echo e(\Carbon\Carbon::now()->locale('es')->monthName); ?> del <?php echo e(date('Y')); ?>

                        </p>
                        <h1 class="text-3xl font-extrabold text-slate-900">
                            Hola, <span class="text-transparent bg-clip-text bg-gradient-to-r from-slate-700 to-slate-500"><?php echo e(Auth::user()->name); ?></span>
                        </h1>
                    ...
                    <div class="mt-6 md:mt-0 flex flex-wrap gap-3 items-center">
                        ...
                        <?php if(Auth::user()->isAdmin()): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-xs font-bold uppercase tracking-wide rounded-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-0.5 transition-all">
                        ...
                        <?php if(Auth::user()->isRh()): ?>
                             <a href="<?php echo e(route('recursos-humanos.index')); ?>" class="inline-flex items-center px-4 py-2 bg-pink-600 text-white text-xs font-bold uppercase tracking-wide rounded-xl shadow-lg shadow-pink-200 hover:bg-pink-700 hover:-translate-y-0.5 transition-all">
                        ...
                        <?php if(Auth::user()->isLogistica()): ?>
                             <a href="<?php echo e(route('logistica.index')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-xs font-bold uppercase tracking-wide rounded-xl shadow-lg shadow-blue-200 hover:bg-blue-700 hover:-translate-y-0.5 transition-all">
                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <a href="<?php echo e(route('activities.index')); ?>" class="group relative bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 flex items-start gap-5 overflow-hidden">
                        ...
                        <a href="<?php echo e(route('rh.evaluacion.index')); ?>" class="group relative bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:shadow-lg hover:border-emerald-200 transition-all duration-300 flex items-start gap-5 overflow-hidden">
                            <div class="absolute right-0 top-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                        ...
                        <a href="<?php echo e(route('capacitacion.index')); ?>" class="group relative bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:shadow-lg hover:border-violet-200 transition-all duration-300 flex items-start gap-5 overflow-hidden">
                            <div class="absolute right-0 top-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                        ...
                        <a href="<?php echo e(route('tickets.mis-tickets')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-bold text-slate-600 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 transition-all shadow-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $srv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($srv['route']); ?>" class="bg-white p-5 rounded-xl border border-slate-100 shadow-sm hover:shadow-md hover:border-<?php echo e($srv['color']); ?>-200 transition-all group flex flex-col h-full">
                                <div class="flex items-center gap-4 mb-3">
                                    <div class="w-10 h-10 rounded-lg bg-<?php echo e($srv['color']); ?>-50 text-<?php echo e($srv['color']); ?>-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($srv['icon']); ?>"></path></svg>
                                    </div>
                                    <h4 class="font-bold text-slate-800 group-hover:text-<?php echo e($srv['color']); ?>-600 transition-colors"><?php echo e($srv['title']); ?></h4>
                                </div>
                                <p class="text-xs text-slate-500 mb-4 flex-1">
                                    <?php echo e($srv['desc']); ?>

                                </p>
                                <div class="text-[10px] font-bold text-<?php echo e($srv['color']); ?>-600 uppercase tracking-wider flex items-center">
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\trade\Desktop\Proyectos\ERP_EstrategiaeInnovacion\resources\views/welcome.blade.php ENDPATH**/ ?>