...
<?php $__env->startSection('content'); ?>
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-slate-200" id="pedimentosTableBody">
                                    ...
                                    <tr class="hover:bg-indigo-50/50 transition-colors">
                                        ...
                                        <td class="px-4 py-3 text-sm text-slate-600">
                                            <?php if($pedimento->subcategoria): ?>
                                                <span class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-green-100 text-green-800">
                                                    <?php echo e($pedimento->subcategoria); ?>
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <div class="flex justify-center space-x-2">
                                                <button onclick="editarPedimento(<?php echo e($pedimento->id); ?>, '<?php echo e($pedimento->clave); ?>', '<?php echo e(addslashes($pedimento->descripcion)); ?>', '<?php echo e(addslashes($pedimento->categoria ?? '')); ?>', '<?php echo e(addslashes($pedimento->subcategoria ?? '')); ?>')"
                                                        class="text-blue-600 hover:text-blue-800 transition-colors" title="Editar">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
    ...
    <div id="importPedimentosModal" class="modal-overlay fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-lg transform scale-95 transition-all duration-300">
            ...
            <form id="importPedimentosForm" class="p-6" enctype="multipart/form-data" action="<?php echo e(route('logistica.pedimentos.import')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-6">
