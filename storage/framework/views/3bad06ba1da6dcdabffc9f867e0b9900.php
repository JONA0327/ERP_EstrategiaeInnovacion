...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('capacitacion.index')); ?>" class="text-indigo-600 hover:text-indigo-900 font-bold">Ir a la Galería Pública &rarr;</a>
    </div>

    <div class="bg-white rounded-lg shadow-sm p-6 mb-8 border border-gray-200">
        <h3 class="text-lg font-semibold mb-4 text-gray-700">Subir Nuevo Video</h3>
        <form action="<?php echo e(route('rh.capacitacion.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-bold text-gray-900"><?php echo e($video->titulo); ?></div>
                        <div class="text-xs text-gray-500 truncate max-w-xs"><?php echo e($video->descripcion); ?></div>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <form action="<?php echo e(route('rh.capacitacion.destroy', $video->id)); ?>" method="POST" onsubmit="return confirm('¿Eliminar video permanentemente?');">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="text-red-600 hover:text-red-900">Eliminar</button>
                            <a href="<?php echo e(route('rh.capacitacion.edit', $video->id)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Editar</a>
                        </form>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\trade\Desktop\Proyectos\ERP_EstrategiaeInnovacion\resources\views/Recursos_Humanos/capacitacion/manage.blade.php ENDPATH**/ ?>