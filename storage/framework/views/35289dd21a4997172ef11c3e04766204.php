...
<nav <?php echo e($attributes->merge([
    ...
    <?php if(auth()->check() && auth()->user()->isAdmin()): ?>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e($linkBase); ?> gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="h-4 w-4 shrink-0">
    ...
    <a href="<?php echo e(route('tickets.mis-tickets')); ?>" class="<?php echo e($linkBase); ?> gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="h-4 w-4 shrink-0">
...
<?php /**PATH C:\Users\trade\Desktop\Proyectos\ERP_EstrategiaeInnovacion\resources\views\Sistemas_IT/components/nav-links.blade.php ENDPATH**/ ?>