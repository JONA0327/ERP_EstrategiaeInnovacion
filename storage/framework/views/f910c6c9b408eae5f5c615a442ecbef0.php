<?php $__env->startSection('title', 'Logística - Portal Interno'); ?>

<?php $__env->startSection('content'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/Logistica/index.css','resources/js/Logistica/index.js']); ?>
        ...
        <div class="relative max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-10">
            ...
            <?php
                $cards = [
                    ...
                    [
                        'title' => 'Pedimentos',
                        'description' => 'Administra el estado de pago de pedimentos asociados a las operaciones logísticas.',
                        'href' => route('logistica.pedimentos.index'),
                        'cta' => 'Gestionar pedimentos',
                        'status' => 'Disponible',
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative overflow-hidden rounded-3xl border border-blue-100/80 bg-white/90 backdrop-blur shadow-lg shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
                        ...
                        <div class="relative p-8">
                            ...
                            <a href="<?php echo e(route('logistica.reportes')); ?>" class="group inline-flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 transition-all duration-300 hover:from-blue-700 hover:to-blue-800">
                                <svg class="w-5 h-5 mr-2 transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                </svg>
                                Abrir módulo
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SISTEMAS\Downloads\ERP EstrategiaeInnovacion\Sistema_Tickets_E-I\resources\views/Logistica/index.blade.php ENDPATH**/ ?>