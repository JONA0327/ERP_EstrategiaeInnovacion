                    ...
                    <div class="relative inline-block text-left">
                        ...
                        <div id="exportDropdown" class="hidden origin-top-right absolute right-0 mt-2 w-64 rounded-lg export-dropdown bg-white ring-1 ring-black ring-opacity-5 z-50">
                            <div class="py-1">
                                ...
                                <!-- Excel Profesional -->
                                <a href="{{ route('logistica.reportes.export-excel', request()->query()) }}" 
                ...
                <form id="emailForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="destinatarios" name="destinatarios" rows="3" 
                                  ...
                                  required></textarea>
                        <p class="text-xs text-slate-500 mt-1">Separar múltiples correos con comas</p>
                    </div>
...
{{ auth()->user()->name ?? 'Equipo de Logística' }}</textarea>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <h4 class="text-sm font-medium text-blue-800">Correos CC Automáticos</h4>
                                <p class="text-xs text-blue-700 mt-1">
                                    Se incluirán automáticamente en CC los administradores de logística configurados en el catálogo.
...
{{ auth()->user()->name ?? 'Equipo de Logística' }}`;
        ...
        document.getElementById('emailForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                // Incluir IDs de operaciones actuales según filtros aplicados (opcional)
                // Aquí se pueden agregar los IDs de las operaciones filtradas si es necesario
        ...
        function exportExcelDashboard() {
            ...
            const exportUrl = `{{ route('logistica.reportes.export-excel') }}?${params.toString()}`;
