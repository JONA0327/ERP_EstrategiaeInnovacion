    ...
    <main class="relative overflow-hidden bg-slate-50 min-h-screen">
        ...
        <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                ...
                <section class="max-w-md mx-auto">
                    <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden relative group hover:shadow-2xl transition-all duration-300">
                        ...
                        <div class="p-8 sm:p-10 text-center">
                            ...
                            <div class="space-y-4">
                                <a href="{{ route('login') }}" class="flex items-center justify-center w-full px-6 py-3.5 bg-indigo-600 text-white font-bold text-sm rounded-xl hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-100 transition-all shadow-lg shadow-indigo-200 hover:-translate-y-0.5">Iniciar Sesión</a>
                                <a href="{{ route('register') }}" class="flex items-center justify-center w-full px-6 py-3.5 bg-white text-slate-700 font-bold text-sm rounded-xl border border-slate-200 hover:bg-slate-50 hover:border-slate-300 focus:ring-4 focus:ring-slate-100 transition-all">Solicitar Acceso</a>
                            </div>
                        </div>
            ...
            @auth
                {{-- 
                    AQUÍ ESTÁ LA MAGIA: 
                    Unificamos todo en un solo array para mantener la consistencia del diseño.
                    Tickets + Evaluación + Actividades.
                --}}
                @php
                    $cards = [
                        // --- TICKETS ---
