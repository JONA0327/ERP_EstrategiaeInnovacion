<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('recursos-humanos.index') }}" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium flex items-center gap-1">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-indigo-500">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 mb-8">
                        ...
                        @foreach($areasEval as $area)
                            <button 
                                onclick="cargarEmpleados('{{ $area }}')"
                                ...
                                <div class="mb-2 p-2 rounded-full bg-white shadow-sm group-hover:scale-110 transition-transform">
                                    {{-- Iconos dinámicos simples basados en el nombre --}}
                                    @if($area == 'TI')
                                    ...
                                    @elseif($area == 'Logistica' || $area == 'Pedimentos')
                                ...
                                <span class="text-sm font-medium text-gray-700 group-hover:text-indigo-700 text-center">{{ $area }}</span>
                                
                                {{-- Indicador de activo (oculto por defecto) --}}
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full text-sm text-left text-gray-500">
                                ...
                                <tbody id="tabla-body-empleados">
                                    {{-- Aquí se inyectan los rows via JS --}}
                                </tbody>
                            </table>
                        </div>
